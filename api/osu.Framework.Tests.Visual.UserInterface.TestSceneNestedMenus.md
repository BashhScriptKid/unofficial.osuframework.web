# <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus"></a> Class TestSceneNestedMenus
...
```csharp
public class TestSceneNestedMenus : MenuTestScene, IDependencyInjectionCandidate, IDisposable, IContainerEnumerable<Drawable>, IContainerCollection<Drawable>, IContainer, IDrawable, ITransformable, ICollection<Drawable>, IReadOnlyList<Drawable>, IReadOnlyCollection<Drawable>, IEnumerable<Drawable>, IEnumerable, ISourceGeneratedDependencyActivator, ISourceGeneratedHandleInputCache, ISourceGeneratedLongRunningLoadCache
```
...
[TestSceneNestedMenus](osu.Framework.Tests.Visual.UserInterface.TestSceneNestedMenus.md)
...
[MenuTestScene.Menus](osu.Framework.Testing.MenuTestScene.md\#osu\_Framework\_Testing\_MenuTestScene\_Menus), 
[MenuTestScene.CreateMenu\(Func<Menu\>\)](osu.Framework.Testing.MenuTestScene.md\#osu\_Framework\_Testing\_MenuTestScene\_CreateMenu\_System\_Func\_osu\_Framework\_Graphics\_UserInterface\_Menu\_\_), 
[MenuTestScene.ClickItem\(int, int\)](osu.Framework.Testing.MenuTestScene.md\#osu\_Framework\_Testing\_MenuTestScene\_ClickItem\_System\_Int32\_System\_Int32\_), 
[MenuTestScene.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Testing.MenuTestScene.md\#osu\_Framework\_Testing\_MenuTestScene\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[ManualInputManagerTestScene.Content](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_Content), 
[ManualInputManagerTestScene.InitialMousePosition](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_InitialMousePosition), 
[ManualInputManagerTestScene.InputManager](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_InputManager), 
[ManualInputManagerTestScene.SetUp\(\)](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_SetUp), 
[ManualInputManagerTestScene.Update\(\)](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_Update), 
[ManualInputManagerTestScene.ResetInput\(\)](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_ResetInput), 
[ManualInputManagerTestScene.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Testing.ManualInputManagerTestScene.md\#osu\_Framework\_Testing\_ManualInputManagerTestScene\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<TestSceneNestedMenus\>\(TestSceneNestedMenus, params TransformSequence<TestSceneNestedMenus\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<TestSceneNestedMenus\>\(TestSceneNestedMenus?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, params TransformSequence<TestSceneNestedMenus\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<TestSceneNestedMenus\>\(TestSceneNestedMenus\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<TestSceneNestedMenus\>\(TestSceneNestedMenus, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Color4, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Color4, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<TestSceneNestedMenus\>\(TestSceneNestedMenus, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
...
[ExtensionMethods.GetLocalisableDescription<TestSceneNestedMenus\>\(TestSceneNestedMenus\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<TestSceneNestedMenus\>\(TestSceneNestedMenus\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<TestSceneNestedMenus\>\(TestSceneNestedMenus\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, int, params TransformSequence<TestSceneNestedMenus\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, params TransformSequence<TestSceneNestedMenus\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TestSceneNestedMenus\>\(TestSceneNestedMenus, params TransformSequence<TestSceneNestedMenus\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TestSceneNestedMenus\>\(TestSceneNestedMenus, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<TestSceneNestedMenus, TValue\>\(TestSceneNestedMenus, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<TestSceneNestedMenus, TEasing, TValue\>\(TestSceneNestedMenus, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, TestSceneNestedMenus\>\(TestSceneNestedMenus, Transform<TValue, DefaultEasingFunction, TestSceneNestedMenus\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, TestSceneNestedMenus\>\(TestSceneNestedMenus, Transform<TValue, TEasing, TestSceneNestedMenus\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
[TransformableExtensions.Spin<TestSceneNestedMenus\>\(TestSceneNestedMenus, double, RotationDirection, float, int\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_System\_Int32\_), 
[TransformableExtensions.TransformBindableTo<TestSceneNestedMenus, TValue\>\(TestSceneNestedMenus, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<TestSceneNestedMenus, TValue, TEasing\>\(TestSceneNestedMenus, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformTo<TestSceneNestedMenus, TValue\>\(TestSceneNestedMenus, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<TestSceneNestedMenus, TValue, TEasing\>\(TestSceneNestedMenus, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[TransformableExtensions.TweenEdgeEffectTo<TestSceneNestedMenus\>\(TestSceneNestedMenus, EdgeEffectParameters, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TweenEdgeEffectTo<TestSceneNestedMenus, TEasing\>\(TestSceneNestedMenus, EdgeEffectParameters, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_\_\_1\_\_), 
[DrawableExtensions.With<TestSceneNestedMenus\>\(TestSceneNestedMenus, Action<TestSceneNestedMenus\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<TestSceneNestedMenus, TChild\>\(TestSceneNestedMenus, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<TestSceneNestedMenus, TChild\>\(TestSceneNestedMenus, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<TestSceneNestedMenus, TChild\>\(TestSceneNestedMenus, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<TestSceneNestedMenus\>\(TestSceneNestedMenus\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Methods

### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_SetUp"></a> SetUp\(\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestActionClick"></a> TestActionClick\(\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestActionClickClosesMenus"></a> TestActionClickClosesMenus\(\)

Tests whether clicking on an action in a sub-menu closes all <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref>s.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestAlwaysOpen"></a> TestAlwaysOpen\(\)

Tests if the <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref> respects <xref href="osu.Framework.Graphics.UserInterface.Menu.TopLevelMenu" data-throw-if-not-resolved="false"></xref> = true, by not alowing it to be closed
when a click happens outside the <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref>.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestClickingOutsideClosesMenus_System_Boolean_"></a> TestClickingOutsideClosesMenus\(bool\)

Tests whether clicking outside the <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref> structure closes all sub-menus.
...
`hoverPrevious` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Whether the previous menu should first be hovered before clicking outside.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestDelayedHoverChange"></a> TestDelayedHoverChange\(\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestDoubleClick"></a> TestDoubleClick\(\)

Tests if clicking once on a menu that has <xref href="osu.Framework.Graphics.UserInterface.Menu.TopLevelMenu" data-throw-if-not-resolved="false"></xref> opens it, and clicking a second time
closes it.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestHoverChange"></a> TestHoverChange\(\)

Tests if hovering over a different item on the main <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref> will instantly open another menu
and correctly changes the sub-menu items to the new items from the hovered item.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestHoverOpen"></a> TestHoverOpen\(\)

Tests if hovering over menu items respects the <xref href="osu.Framework.Graphics.UserInterface.Menu.HoverOpenDelay" data-throw-if-not-resolved="false"></xref>.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestHoverState"></a> TestHoverState\(\)

Tests if the hover state on <xref href="osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem" data-throw-if-not-resolved="false"></xref>s is valid.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestInstantOpen"></a> TestInstantOpen\(\)

Tests whether click on <xref href="osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem" data-throw-if-not-resolved="false"></xref>s causes sub-menus to instantly appear.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestMenuClickClosesSubMenus"></a> TestMenuClickClosesSubMenus\(\)

Tests whether clicking on the <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref> that has <xref href="osu.Framework.Graphics.UserInterface.Menu.TopLevelMenu" data-throw-if-not-resolved="false"></xref> closes all sub menus.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestMenuClicksDontClose"></a> TestMenuClicksDontClose\(\)

Tests whether clicking on <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref>s that have opened sub-menus don't close the sub-menus.
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestSelectedState"></a> TestSelectedState\(\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestSubMenuOverflow_osu_Framework_Graphics_Anchor_osu_Framework_Graphics_Direction_"></a> TestSubMenuOverflow\(Anchor, Direction\)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestSubMenuOverflowPlayground_osu_Framework_Graphics_Direction_osu_Framework_Graphics_Direction_"></a> TestSubMenuOverflowPlayground\(Direction, Direction\)

```csharp
[Test]
public void TestSubMenuOverflowPlayground(Direction direction, Direction subMenuDirection)
```
...
`subMenuDirection` [Direction](osu.Framework.Graphics.Direction.md)
...
### <a id="osu_Framework_Tests_Visual_UserInterface_TestSceneNestedMenus_TestTopLevelMenu"></a> TestTopLevelMenu\(\)

Tests if the <xref href="osu.Framework.Graphics.UserInterface.Menu" data-throw-if-not-resolved="false"></xref> respects <xref href="osu.Framework.Graphics.UserInterface.Menu.TopLevelMenu" data-throw-if-not-resolved="false"></xref> = true.
