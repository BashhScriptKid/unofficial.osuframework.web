# <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector"></a> Class BasicFileSelector

Namespace: [osu.Framework.Graphics.UserInterface](osu.Framework.Graphics.UserInterface.md)  
Assembly: osu.Framework.dll  

```csharp
public class BasicFileSelector : FileSelector, IDependencyInjectionCandidate, IDisposable, IDrawable, ITransformable, ISourceGeneratedHandleInputCache, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache
```
...
[FileSelector](osu.Framework.Graphics.UserInterface.FileSelector.md) ← 
[BasicFileSelector](osu.Framework.Graphics.UserInterface.BasicFileSelector.md)
...
[FileSelector.CreateFileItem\(FileInfo\)](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_CreateFileItem\_System\_IO\_FileInfo\_), 
[FileSelector.CurrentFile](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_CurrentFile), 
[FileSelector.UsingSystemFileSelector](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_UsingSystemFileSelector), 
[FileSelector.TryGetEntriesForPath\(DirectoryInfo, out ICollection<DirectorySelectorItem\>\)](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_TryGetEntriesForPath\_System\_IO\_DirectoryInfo\_System\_Collections\_Generic\_ICollection\_osu\_Framework\_Graphics\_UserInterface\_DirectorySelectorItem\_\_\_), 
[FileSelector.Dispose\(bool\)](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_Dispose\_System\_Boolean\_), 
[FileSelector.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.UserInterface.FileSelector.md\#osu\_Framework\_Graphics\_UserInterface\_FileSelector\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[DirectorySelector.Content](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_Content), 
[DirectorySelector.ShowHiddenItems](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_ShowHiddenItems), 
[DirectorySelector.CreateScrollContainer\(\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CreateScrollContainer), 
[DirectorySelector.CreateBreadcrumb\(\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CreateBreadcrumb), 
[DirectorySelector.CreateHiddenToggleButton\(\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CreateHiddenToggleButton), 
[DirectorySelector.CreateDirectoryItem\(DirectoryInfo, string\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CreateDirectoryItem\_System\_IO\_DirectoryInfo\_System\_String\_), 
[DirectorySelector.CreateParentDirectoryItem\(DirectoryInfo\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CreateParentDirectoryItem\_System\_IO\_DirectoryInfo\_), 
[DirectorySelector.CurrentPath](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_CurrentPath), 
[DirectorySelector.TopLevelContent](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_TopLevelContent), 
[DirectorySelector.LoadComplete\(\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_LoadComplete), 
[DirectorySelector.TryGetEntriesForPath\(DirectoryInfo, out ICollection<DirectorySelectorItem\>\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_TryGetEntriesForPath\_System\_IO\_DirectoryInfo\_System\_Collections\_Generic\_ICollection\_osu\_Framework\_Graphics\_UserInterface\_DirectorySelectorItem\_\_\_), 
[DirectorySelector.NotifySelectionError\(\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_NotifySelectionError), 
[DirectorySelector.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.UserInterface.DirectorySelector.md\#osu\_Framework\_Graphics\_UserInterface\_DirectorySelector\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<BasicFileSelector\>\(BasicFileSelector, params TransformSequence<BasicFileSelector\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<BasicFileSelector\>\(BasicFileSelector?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<BasicFileSelector\>\(BasicFileSelector, double, params TransformSequence<BasicFileSelector\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<BasicFileSelector\>\(BasicFileSelector\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<BasicFileSelector\>\(BasicFileSelector, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<BasicFileSelector, TEasing\>\(BasicFileSelector, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<BasicFileSelector\>\(BasicFileSelector, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<BasicFileSelector, TEasing\>\(BasicFileSelector, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<BasicFileSelector\>\(BasicFileSelector, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<BasicFileSelector, TEasing\>\(BasicFileSelector, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<BasicFileSelector\>\(BasicFileSelector, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<BasicFileSelector, TEasing\>\(BasicFileSelector, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<BasicFileSelector\>\(BasicFileSelector, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<BasicFileSelector, TEasing\>\(BasicFileSelector, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<BasicFileSelector\>\(BasicFileSelector, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<BasicFileSelector, TEasing\>\(BasicFileSelector, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<BasicFileSelector\>\(BasicFileSelector\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<BasicFileSelector\>\(BasicFileSelector\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<BasicFileSelector\>\(BasicFileSelector\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<BasicFileSelector\>\(BasicFileSelector, double, int, params TransformSequence<BasicFileSelector\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicFileSelector\>\(BasicFileSelector, double, params TransformSequence<BasicFileSelector\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicFileSelector\>\(BasicFileSelector, params TransformSequence<BasicFileSelector\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicFileSelector\>\(BasicFileSelector, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<BasicFileSelector, TValue\>\(BasicFileSelector, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<BasicFileSelector, TEasing, TValue\>\(BasicFileSelector, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<BasicFileSelector\>\(BasicFileSelector, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<BasicFileSelector\>\(BasicFileSelector, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<BasicFileSelector, TEasing\>\(BasicFileSelector, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<BasicFileSelector, TEasing\>\(BasicFileSelector, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<BasicFileSelector\>\(BasicFileSelector, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<BasicFileSelector, TEasing\>\(BasicFileSelector, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, BasicFileSelector\>\(BasicFileSelector, Transform<TValue, DefaultEasingFunction, BasicFileSelector\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, BasicFileSelector\>\(BasicFileSelector, Transform<TValue, TEasing, BasicFileSelector\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<BasicFileSelector\>\(BasicFileSelector, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<BasicFileSelector, TEasing\>\(BasicFileSelector, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<BasicFileSelector\>\(BasicFileSelector, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<BasicFileSelector\>\(BasicFileSelector, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<BasicFileSelector, TEasing\>\(BasicFileSelector, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<BasicFileSelector, TEasing\>\(BasicFileSelector, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<BasicFileSelector\>\(BasicFileSelector, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
[TransformableExtensions.Spin<BasicFileSelector\>\(BasicFileSelector, double, RotationDirection, float, int\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_System\_Int32\_), 
[TransformableExtensions.TransformBindableTo<BasicFileSelector, TValue\>\(BasicFileSelector, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<BasicFileSelector, TValue, TEasing\>\(BasicFileSelector, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformTo<BasicFileSelector, TValue\>\(BasicFileSelector, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<BasicFileSelector, TValue, TEasing\>\(BasicFileSelector, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<BasicFileSelector\>\(BasicFileSelector, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[DrawableExtensions.With<BasicFileSelector\>\(BasicFileSelector, Action<BasicFileSelector\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<BasicFileSelector, TChild\>\(BasicFileSelector, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<BasicFileSelector, TChild\>\(BasicFileSelector, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<BasicFileSelector, TChild\>\(BasicFileSelector, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<BasicFileSelector\>\(BasicFileSelector\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector__ctor_System_String_System_String___"></a> BasicFileSelector\(string, string\[\]\)
...
`initialPath` [string](https://learn.microsoft.com/dotnet/api/system.string)

`validFileExtensions` [string](https://learn.microsoft.com/dotnet/api/system.string)\[\]

## Methods

### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateBreadcrumb"></a> CreateBreadcrumb\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateDirectoryItem_System_IO_DirectoryInfo_System_String_"></a> CreateDirectoryItem\(DirectoryInfo, string\)
...
#### Returns
 ...
 [DirectorySelectorDirectory](osu.Framework.Graphics.UserInterface.DirectorySelectorDirectory.md)

### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateFileItem_System_IO_FileInfo_"></a> CreateFileItem\(FileInfo\)

```csharp
protected override FileSelector.DirectoryListingFile CreateFileItem(FileInfo file)
```
...
#### Returns
 ...
 [FileSelector](osu.Framework.Graphics.UserInterface.FileSelector.md).[DirectoryListingFile](osu.Framework.Graphics.UserInterface.FileSelector.DirectoryListingFile.md)

### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateHiddenToggleButton"></a> CreateHiddenToggleButton\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateParentDirectoryItem_System_IO_DirectoryInfo_"></a> CreateParentDirectoryItem\(DirectoryInfo\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_CreateScrollContainer"></a> CreateScrollContainer\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_NotifySelectionError"></a> NotifySelectionError\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicFileSelector_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
