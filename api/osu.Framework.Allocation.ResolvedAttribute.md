# <a id="osu_Framework_Allocation_ResolvedAttribute"></a> Class ResolvedAttribute
...
[ObjectExtensions.AsNonNull<ResolvedAttribute\>\(ResolvedAttribute?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<ResolvedAttribute\>\(ResolvedAttribute\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNotNull<ResolvedAttribute\>\(ResolvedAttribute\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<ResolvedAttribute\>\(ResolvedAttribute\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
[ContainerExtensions.WithChild<ResolvedAttribute, TChild\>\(ResolvedAttribute, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<ResolvedAttribute, TChild\>\(ResolvedAttribute, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<ResolvedAttribute, TChild\>\(ResolvedAttribute, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<ResolvedAttribute\>\(ResolvedAttribute\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Remarks

The value of the property is resolved upon <xref href="osu.Framework.Graphics.Drawable.Load(osu.Framework.Timing.IFrameBasedClock%2cosu.Framework.Allocation.IReadOnlyDependencyContainer%2cSystem.Boolean)" data-throw-if-not-resolved="false"></xref> for the target <xref href="osu.Framework.Graphics.Drawable" data-throw-if-not-resolved="false"></xref>.

## Constructors

### <a id="osu_Framework_Allocation_ResolvedAttribute__ctor"></a> ResolvedAttribute\(\)

Identifies a member to be resolved from a <xref href="osu.Framework.Allocation.DependencyContainer" data-throw-if-not-resolved="false"></xref>.

```csharp
public ResolvedAttribute()
```

### <a id="osu_Framework_Allocation_ResolvedAttribute__ctor_System_Type_System_String_System_Boolean_"></a> ResolvedAttribute\(Type, string, bool\)
...
The parent which the member is identified with in the cache.
    This is only set if the member was cached with a custom <xref href="osu.Framework.Allocation.CacheInfo" data-throw-if-not-resolved="false"></xref>.

`name` [string](https://learn.microsoft.com/dotnet/api/system.string)

The name which the member is identified with in the cache.
    This is only set if the member was cached with a custom <xref href="osu.Framework.Allocation.CacheInfo" data-throw-if-not-resolved="false"></xref>.
...
### <a id="osu_Framework_Allocation_ResolvedAttribute_CanBeNull"></a> CanBeNull
...
### <a id="osu_Framework_Allocation_ResolvedAttribute_Name"></a> Name

The name of the cached member in the <xref href="osu.Framework.Allocation.DependencyContainer" data-throw-if-not-resolved="false"></xref>.
...
### <a id="osu_Framework_Allocation_ResolvedAttribute_Parent"></a> Parent

The containing type of the cached member in the <xref href="osu.Framework.Allocation.DependencyContainer" data-throw-if-not-resolved="false"></xref>.
