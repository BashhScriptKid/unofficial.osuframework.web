# <a id="osu_Framework_Graphics_UserInterface_BasicMenu"></a> Class BasicMenu

Namespace: [osu.Framework.Graphics.UserInterface](osu.Framework.Graphics.UserInterface.md)  
Assembly: osu.Framework.dll  

```csharp
public class BasicMenu : Menu, IDependencyInjectionCandidate, IDisposable, IDrawable, ITransformable, IStateful<MenuState>, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedHandleInputCache, ISourceGeneratedDependencyActivator
```
...
[Menu.StateChanged](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_StateChanged), 
[Menu.OnSubmenuOpen](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnSubmenuOpen), 
[Menu.HoverOpenDelay](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_HoverOpenDelay), 
[Menu.TopLevelMenu](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_TopLevelMenu), 
[Menu.ContentContainer](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_ContentContainer), 
[Menu.ItemsContainer](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_ItemsContainer), 
[Menu.MaskingContainer](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_MaskingContainer), 
[Menu.Children](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Children), 
[Menu.Direction](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Direction), 
[Menu.LoadComplete\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_LoadComplete), 
[Menu.Items](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Items), 
[Menu.BackgroundColour](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_BackgroundColour), 
[Menu.ScrollbarVisible](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_ScrollbarVisible), 
[Menu.MaxWidth](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_MaxWidth), 
[Menu.MaxHeight](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_MaxHeight), 
[Menu.State](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_State), 
[Menu.Add\(MenuItem\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Add\_osu\_Framework\_Graphics\_UserInterface\_MenuItem\_), 
[Menu.Insert\(int, MenuItem\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Insert\_System\_Int32\_osu\_Framework\_Graphics\_UserInterface\_MenuItem\_), 
[Menu.Remove\(MenuItem\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Remove\_osu\_Framework\_Graphics\_UserInterface\_MenuItem\_), 
[Menu.Clear\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Clear), 
[Menu.Open\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Open), 
[Menu.Close\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Close), 
[Menu.Toggle\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Toggle), 
[Menu.AnimateOpen\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_AnimateOpen), 
[Menu.AnimateClose\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_AnimateClose), 
[Menu.Update\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_Update), 
[Menu.UpdateAfterChildren\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_UpdateAfterChildren), 
[Menu.UpdateSize\(Vector2\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_UpdateSize\_osuTK\_Vector2\_), 
[Menu.HandleNonPositionalInput](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_HandleNonPositionalInput), 
[Menu.OnKeyDown\(KeyDownEvent\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnKeyDown\_osu\_Framework\_Input\_Events\_KeyDownEvent\_), 
[Menu.OnMouseDown\(MouseDownEvent\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnMouseDown\_osu\_Framework\_Input\_Events\_MouseDownEvent\_), 
[Menu.OnClick\(ClickEvent\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnClick\_osu\_Framework\_Input\_Events\_ClickEvent\_), 
[Menu.OnHover\(HoverEvent\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnHover\_osu\_Framework\_Input\_Events\_HoverEvent\_), 
[Menu.AcceptsFocus](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_AcceptsFocus), 
[Menu.RequestsFocus](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_RequestsFocus), 
[Menu.OnFocusLost\(FocusLostEvent\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_OnFocusLost\_osu\_Framework\_Input\_Events\_FocusLostEvent\_), 
[Menu.CreateSubMenu\(\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_CreateSubMenu), 
[Menu.CreateDrawableMenuItem\(MenuItem\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_CreateDrawableMenuItem\_osu\_Framework\_Graphics\_UserInterface\_MenuItem\_), 
[Menu.CreateScrollContainer\(Direction\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_CreateScrollContainer\_osu\_Framework\_Graphics\_Direction\_), 
[Menu.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.UserInterface.Menu.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<BasicMenu\>\(BasicMenu, params TransformSequence<BasicMenu\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<BasicMenu\>\(BasicMenu?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<BasicMenu\>\(BasicMenu, double, params TransformSequence<BasicMenu\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<BasicMenu\>\(BasicMenu\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<BasicMenu\>\(BasicMenu, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<BasicMenu, TEasing\>\(BasicMenu, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<BasicMenu\>\(BasicMenu, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<BasicMenu, TEasing\>\(BasicMenu, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<BasicMenu\>\(BasicMenu, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<BasicMenu, TEasing\>\(BasicMenu, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<BasicMenu\>\(BasicMenu, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<BasicMenu, TEasing\>\(BasicMenu, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<BasicMenu\>\(BasicMenu, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<BasicMenu, TEasing\>\(BasicMenu, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<BasicMenu\>\(BasicMenu, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<BasicMenu, TEasing\>\(BasicMenu, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<BasicMenu\>\(BasicMenu\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<BasicMenu\>\(BasicMenu\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<BasicMenu\>\(BasicMenu\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<BasicMenu\>\(BasicMenu, double, int, params TransformSequence<BasicMenu\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicMenu\>\(BasicMenu, double, params TransformSequence<BasicMenu\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicMenu\>\(BasicMenu, params TransformSequence<BasicMenu\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<BasicMenu\>\(BasicMenu, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<BasicMenu, TValue\>\(BasicMenu, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<BasicMenu, TEasing, TValue\>\(BasicMenu, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<BasicMenu\>\(BasicMenu, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<BasicMenu\>\(BasicMenu, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<BasicMenu, TEasing\>\(BasicMenu, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<BasicMenu, TEasing\>\(BasicMenu, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<BasicMenu\>\(BasicMenu, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<BasicMenu, TEasing\>\(BasicMenu, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, BasicMenu\>\(BasicMenu, Transform<TValue, DefaultEasingFunction, BasicMenu\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, BasicMenu\>\(BasicMenu, Transform<TValue, TEasing, BasicMenu\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<BasicMenu\>\(BasicMenu, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<BasicMenu, TEasing\>\(BasicMenu, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<BasicMenu\>\(BasicMenu, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<BasicMenu\>\(BasicMenu, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<BasicMenu, TEasing\>\(BasicMenu, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<BasicMenu, TEasing\>\(BasicMenu, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<BasicMenu\>\(BasicMenu, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
[TransformableExtensions.Spin<BasicMenu\>\(BasicMenu, double, RotationDirection, float, int\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_System\_Int32\_), 
[TransformableExtensions.TransformBindableTo<BasicMenu, TValue\>\(BasicMenu, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<BasicMenu, TValue, TEasing\>\(BasicMenu, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformTo<BasicMenu, TValue\>\(BasicMenu, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<BasicMenu, TValue, TEasing\>\(BasicMenu, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<BasicMenu\>\(BasicMenu, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[DrawableExtensions.With<BasicMenu\>\(BasicMenu, Action<BasicMenu\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<BasicMenu, TChild\>\(BasicMenu, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<BasicMenu, TChild\>\(BasicMenu, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<BasicMenu, TChild\>\(BasicMenu, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<BasicMenu\>\(BasicMenu\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_UserInterface_BasicMenu__ctor_osu_Framework_Graphics_Direction_System_Boolean_"></a> BasicMenu\(Direction, bool\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicMenu_CreateDrawableMenuItem_osu_Framework_Graphics_UserInterface_MenuItem_"></a> CreateDrawableMenuItem\(MenuItem\)
...
```csharp
protected override Menu.DrawableMenuItem CreateDrawableMenuItem(MenuItem item)
```
...
### <a id="osu_Framework_Graphics_UserInterface_BasicMenu_CreateScrollContainer_osu_Framework_Graphics_Direction_"></a> CreateScrollContainer\(Direction\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicMenu_CreateSubMenu"></a> CreateSubMenu\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_BasicMenu_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
