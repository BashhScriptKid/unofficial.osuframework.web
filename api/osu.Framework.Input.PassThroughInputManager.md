# <a id="osu_Framework_Input_PassThroughInputManager"></a> Class PassThroughInputManager
...
```csharp
public class PassThroughInputManager : CustomInputManager, IDependencyInjectionCandidate, IDisposable, IContainerEnumerable<Drawable>, IContainerCollection<Drawable>, IContainer, ICollection<Drawable>, IReadOnlyList<Drawable>, IReadOnlyCollection<Drawable>, IEnumerable<Drawable>, IEnumerable, IInputStateChangeHandler, IFocusManager, IRequireHighFrequencyMousePosition, IDrawable, ITransformable, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedDependencyActivator, ISourceGeneratedHandleInputCache
```
...
[ManualInputManager](osu.Framework.Testing.Input.ManualInputManager.md), 
...
[CustomInputManager.InputHandlers](osu.Framework.Input.CustomInputManager.md\#osu\_Framework\_Input\_CustomInputManager\_InputHandlers), 
[CustomInputManager.AddHandler\(InputHandler\)](osu.Framework.Input.CustomInputManager.md\#osu\_Framework\_Input\_CustomInputManager\_AddHandler\_osu\_Framework\_Input\_Handlers\_InputHandler\_), 
[CustomInputManager.RemoveHandler\(InputHandler\)](osu.Framework.Input.CustomInputManager.md\#osu\_Framework\_Input\_CustomInputManager\_RemoveHandler\_osu\_Framework\_Input\_Handlers\_InputHandler\_), 
[CustomInputManager.Dispose\(bool\)](osu.Framework.Input.CustomInputManager.md\#osu\_Framework\_Input\_CustomInputManager\_Dispose\_System\_Boolean\_), 
[CustomInputManager.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Input.CustomInputManager.md\#osu\_Framework\_Input\_CustomInputManager\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[InputManager.Host](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_Host), 
[InputManager.FocusedDrawable](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_FocusedDrawable), 
[InputManager.InputHandlers](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_InputHandlers), 
[InputManager.CreateInitialState\(\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateInitialState), 
[InputManager.CurrentState](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CurrentState), 
[InputManager.DraggedDrawable](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_DraggedDrawable), 
[InputManager.HoveredDrawables](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HoveredDrawables), 
[InputManager.PositionalInputQueue](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_PositionalInputQueue), 
[InputManager.NonPositionalInputQueue](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_NonPositionalInputQueue), 
[InputManager.MapMouseToLatestTouch](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_MapMouseToLatestTouch), 
[InputManager.AllowRightClickFromLongTouch](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_AllowRightClickFromLongTouch), 
[InputManager.LoadComplete\(\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_LoadComplete), 
[InputManager.CreateButtonEventManagerFor\(MouseButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osuTK\_Input\_MouseButton\_), 
[InputManager.GetButtonEventManagerFor\(MouseButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osuTK\_Input\_MouseButton\_), 
[InputManager.CreateButtonEventManagerFor\(Key\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osuTK\_Input\_Key\_), 
[InputManager.GetButtonEventManagerFor\(Key\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osuTK\_Input\_Key\_), 
[InputManager.CreateButtonEventManagerFor\(TouchSource\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osu\_Framework\_Input\_TouchSource\_), 
[InputManager.GetButtonEventManagerFor\(TouchSource\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osu\_Framework\_Input\_TouchSource\_), 
[InputManager.CreateButtonEventManagerFor\(TabletPenButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osu\_Framework\_Input\_TabletPenButton\_), 
[InputManager.GetButtonEventManagerFor\(TabletPenButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osu\_Framework\_Input\_TabletPenButton\_), 
[InputManager.CreateButtonEventManagerFor\(TabletAuxiliaryButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osu\_Framework\_Input\_TabletAuxiliaryButton\_), 
[InputManager.GetButtonEventManagerFor\(TabletAuxiliaryButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osu\_Framework\_Input\_TabletAuxiliaryButton\_), 
[InputManager.CreateButtonEventManagerFor\(JoystickButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osu\_Framework\_Input\_JoystickButton\_), 
[InputManager.GetButtonEventManagerFor\(JoystickButton\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osu\_Framework\_Input\_JoystickButton\_), 
[InputManager.CreateButtonEventManagerFor\(MidiKey\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateButtonEventManagerFor\_osu\_Framework\_Input\_MidiKey\_), 
[InputManager.GetButtonEventManagerFor\(MidiKey\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetButtonEventManagerFor\_osu\_Framework\_Input\_MidiKey\_), 
[InputManager.CreateJoystickAxisEventManagerFor\(JoystickAxisSource\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_CreateJoystickAxisEventManagerFor\_osu\_Framework\_Input\_JoystickAxisSource\_), 
[InputManager.GetJoystickAxisEventManagerFor\(JoystickAxisSource\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetJoystickAxisEventManagerFor\_osu\_Framework\_Input\_JoystickAxisSource\_), 
[InputManager.TriggerFocusContention\(Drawable\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_TriggerFocusContention\_osu\_Framework\_Graphics\_Drawable\_), 
[InputManager.ChangeFocus\(Drawable\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_ChangeFocus\_osu\_Framework\_Graphics\_Drawable\_), 
[InputManager.ChangeFocus\(Drawable, InputState\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_ChangeFocus\_osu\_Framework\_Graphics\_Drawable\_osu\_Framework\_Input\_States\_InputState\_), 
[InputManager.Update\(\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_Update), 
[InputManager.GetPendingInputs\(\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_GetPendingInputs), 
[InputManager.HandleHoverEvents](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleHoverEvents), 
[InputManager.HandleKeyboardKeyStateChange\(ButtonStateChangeEvent<Key\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleKeyboardKeyStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osuTK\_Input\_Key\_\_), 
[InputManager.HandleTouchStateChange\(TouchStateChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleTouchStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_TouchStateChangeEvent\_), 
[InputManager.TouchLongPressBegan](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_TouchLongPressBegan), 
[InputManager.TouchLongPressCancelled](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_TouchLongPressCancelled), 
[InputManager.HandleMouseTouchStateChange\(TouchStateChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleMouseTouchStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_TouchStateChangeEvent\_), 
[InputManager.HandleTabletPenButtonStateChange\(ButtonStateChangeEvent<TabletPenButton\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleTabletPenButtonStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osu\_Framework\_Input\_TabletPenButton\_\_), 
[InputManager.HandleTabletAuxiliaryButtonStateChange\(ButtonStateChangeEvent<TabletAuxiliaryButton\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleTabletAuxiliaryButtonStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osu\_Framework\_Input\_TabletAuxiliaryButton\_\_), 
[InputManager.HandleJoystickButtonStateChange\(ButtonStateChangeEvent<JoystickButton\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleJoystickButtonStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osu\_Framework\_Input\_JoystickButton\_\_), 
[InputManager.HandleMidiKeyStateChange\(ButtonStateChangeEvent<MidiKey\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleMidiKeyStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osu\_Framework\_Input\_MidiKey\_\_), 
[InputManager.HandleInputStateChange\(InputStateChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleInputStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_InputStateChangeEvent\_), 
[InputManager.HandleJoystickAxisChange\(JoystickAxisChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleJoystickAxisChange\_osu\_Framework\_Input\_StateChanges\_Events\_JoystickAxisChangeEvent\_), 
[InputManager.HandleMousePositionChange\(MousePositionChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleMousePositionChange\_osu\_Framework\_Input\_StateChanges\_Events\_MousePositionChangeEvent\_), 
[InputManager.HandleMouseScrollChange\(MouseScrollChangeEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleMouseScrollChange\_osu\_Framework\_Input\_StateChanges\_Events\_MouseScrollChangeEvent\_), 
[InputManager.HandleMouseButtonStateChange\(ButtonStateChangeEvent<MouseButton\>\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_HandleMouseButtonStateChange\_osu\_Framework\_Input\_StateChanges\_Events\_ButtonStateChangeEvent\_osuTK\_Input\_MouseButton\_\_), 
[InputManager.PropagateBlockableEvent\(SlimReadOnlyListWrapper<Drawable\>, UIEvent\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_PropagateBlockableEvent\_osu\_Framework\_Lists\_SlimReadOnlyListWrapper\_osu\_Framework\_Graphics\_Drawable\_\_osu\_Framework\_Input\_Events\_UIEvent\_), 
[InputManager.ChangeFocusFromClick\(Drawable\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_ChangeFocusFromClick\_osu\_Framework\_Graphics\_Drawable\_), 
[InputManager.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Input.InputManager.md\#osu\_Framework\_Input\_InputManager\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<PassThroughInputManager\>\(PassThroughInputManager, params TransformSequence<PassThroughInputManager\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<PassThroughInputManager\>\(PassThroughInputManager?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<PassThroughInputManager\>\(PassThroughInputManager, double, params TransformSequence<PassThroughInputManager\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<PassThroughInputManager\>\(PassThroughInputManager\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<PassThroughInputManager\>\(PassThroughInputManager, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<PassThroughInputManager, TEasing\>\(PassThroughInputManager, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<PassThroughInputManager\>\(PassThroughInputManager, Color4, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Color4, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<PassThroughInputManager\>\(PassThroughInputManager, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<PassThroughInputManager, TEasing\>\(PassThroughInputManager, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<PassThroughInputManager\>\(PassThroughInputManager, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<PassThroughInputManager, TEasing\>\(PassThroughInputManager, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<PassThroughInputManager\>\(PassThroughInputManager, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<PassThroughInputManager, TEasing\>\(PassThroughInputManager, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<PassThroughInputManager\>\(PassThroughInputManager, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<PassThroughInputManager, TEasing\>\(PassThroughInputManager, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<PassThroughInputManager\>\(PassThroughInputManager, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<PassThroughInputManager, TEasing\>\(PassThroughInputManager, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
...
[ExtensionMethods.GetLocalisableDescription<PassThroughInputManager\>\(PassThroughInputManager\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<PassThroughInputManager\>\(PassThroughInputManager\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<PassThroughInputManager\>\(PassThroughInputManager\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<PassThroughInputManager\>\(PassThroughInputManager, double, int, params TransformSequence<PassThroughInputManager\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
...
[TransformableExtensions.Loop<PassThroughInputManager\>\(PassThroughInputManager, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<PassThroughInputManager, TValue\>\(PassThroughInputManager, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<PassThroughInputManager, TEasing, TValue\>\(PassThroughInputManager, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<PassThroughInputManager\>\(PassThroughInputManager, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, PassThroughInputManager\>\(PassThroughInputManager, Transform<TValue, DefaultEasingFunction, PassThroughInputManager\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, PassThroughInputManager\>\(PassThroughInputManager, Transform<TValue, TEasing, PassThroughInputManager\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<PassThroughInputManager\>\(PassThroughInputManager, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<PassThroughInputManager\>\(PassThroughInputManager, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
...
[TransformableExtensions.TransformBindableTo<PassThroughInputManager, TValue\>\(PassThroughInputManager, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<PassThroughInputManager, TValue, TEasing\>\(PassThroughInputManager, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<PassThroughInputManager\>\(PassThroughInputManager, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformTo<PassThroughInputManager, TValue\>\(PassThroughInputManager, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<PassThroughInputManager, TValue, TEasing\>\(PassThroughInputManager, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<PassThroughInputManager\>\(PassThroughInputManager, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[TransformableExtensions.TweenEdgeEffectTo<PassThroughInputManager\>\(PassThroughInputManager, EdgeEffectParameters, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TweenEdgeEffectTo<PassThroughInputManager, TEasing\>\(PassThroughInputManager, EdgeEffectParameters, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_\_\_1\_\_), 
[DrawableExtensions.With<PassThroughInputManager\>\(PassThroughInputManager, Action<PassThroughInputManager\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<PassThroughInputManager, TChild\>\(PassThroughInputManager, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<PassThroughInputManager, TChild\>\(PassThroughInputManager, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<PassThroughInputManager, TChild\>\(PassThroughInputManager, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<PassThroughInputManager\>\(PassThroughInputManager\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Remarks

There are two modes of operation for this class:
When <xref href="osu.Framework.Input.PassThroughInputManager.UseParentInput" data-throw-if-not-resolved="false"></xref> is false, this input manager gets inputs only from own input handlers.
When <xref href="osu.Framework.Input.PassThroughInputManager.UseParentInput" data-throw-if-not-resolved="false"></xref> is true, this input manager ignore any local input handlers and
gets inputs from the parent (its ancestor in the scene graph) <xref href="osu.Framework.Input.InputManager" data-throw-if-not-resolved="false"></xref> in the following way:
For mouse input, this only considers input that is passed as events such as <xref href="osu.Framework.Input.Events.MouseDownEvent" data-throw-if-not-resolved="false"></xref>.
For keyboard and other inputs, this input manager try to reflect parent <xref href="osu.Framework.Input.InputManager" data-throw-if-not-resolved="false"></xref>'s <xref href="osu.Framework.Input.States.InputState" data-throw-if-not-resolved="false"></xref> closely as possible.
Thus, when this is attached to the scene graph initially and when <xref href="osu.Framework.Input.PassThroughInputManager.UseParentInput" data-throw-if-not-resolved="false"></xref> becomes true,
multiple events may fire to synchronise the local <xref href="osu.Framework.Input.States.InputState" data-throw-if-not-resolved="false"></xref> with the parent's.

## Properties

### <a id="osu_Framework_Input_PassThroughInputManager_HandleHoverEvents"></a> HandleHoverEvents
...
```csharp
public override bool HandleHoverEvents { get; }
```
...
### <a id="osu_Framework_Input_PassThroughInputManager_UseParentInput"></a> UseParentInput

If there's an InputManager above us, decide whether we should use their available state.

```csharp
public virtual bool UseParentInput { get; set; }
```
...
### <a id="osu_Framework_Input_PassThroughInputManager_GetPendingInputs"></a> GetPendingInputs\(\)
...
### <a id="osu_Framework_Input_PassThroughInputManager_Handle_osu_Framework_Input_Events_UIEvent_"></a> Handle\(UIEvent\)
...
### <a id="osu_Framework_Input_PassThroughInputManager_LoadComplete"></a> LoadComplete\(\)
...
### <a id="osu_Framework_Input_PassThroughInputManager_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
...
### <a id="osu_Framework_Input_PassThroughInputManager_Update"></a> Update\(\)
