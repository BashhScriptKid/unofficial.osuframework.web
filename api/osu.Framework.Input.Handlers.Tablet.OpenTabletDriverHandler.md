# <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler"></a> Class OpenTabletDriverHandler

Namespace: [osu.Framework.Input.Handlers.Tablet](osu.Framework.Input.Handlers.Tablet.md)  
Assembly: osu.Framework.dll  

```csharp
public class OpenTabletDriverHandler : InputHandler, IDisposable, IHasDescription, IAbsolutePointer, IRelativePointer, IPressureHandler, ITabletHandler
```
...
IRelativePointer, 
IPressureHandler, 
[ITabletHandler](osu.Framework.Input.Handlers.Tablet.ITabletHandler.md)
...
[ObjectExtensions.AsNonNull<OpenTabletDriverHandler\>\(OpenTabletDriverHandler?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<OpenTabletDriverHandler\>\(OpenTabletDriverHandler\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNotNull<OpenTabletDriverHandler\>\(OpenTabletDriverHandler\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<OpenTabletDriverHandler\>\(OpenTabletDriverHandler\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
[ContainerExtensions.WithChild<OpenTabletDriverHandler, TChild\>\(OpenTabletDriverHandler, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<OpenTabletDriverHandler, TChild\>\(OpenTabletDriverHandler, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<OpenTabletDriverHandler, TChild\>\(OpenTabletDriverHandler, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<OpenTabletDriverHandler\>\(OpenTabletDriverHandler\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Properties

### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_AreaOffset"></a> AreaOffset

The offset of the area which should be mapped to the game window.

```csharp
public Bindable<Vector2> AreaOffset { get; }
```
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_AreaSize"></a> AreaSize

The size of the area which should be mapped to the game window.

```csharp
public Bindable<Vector2> AreaSize { get; }
```
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_Description"></a> Description
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_IsActive"></a> IsActive
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_Rotation"></a> Rotation

The rotation of the tablet area in degrees.

```csharp
public Bindable<float> Rotation { get; }
```
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_Tablet"></a> Tablet

Information on the currently connected tablet device. May be null if no tablet is detected.

```csharp
public IBindable<TabletInfo?> Tablet { get; }
```
...
### <a id="osu_Framework_Input_Handlers_Tablet_OpenTabletDriverHandler_Initialize_osu_Framework_Platform_GameHost_"></a> Initialize\(GameHost\)
