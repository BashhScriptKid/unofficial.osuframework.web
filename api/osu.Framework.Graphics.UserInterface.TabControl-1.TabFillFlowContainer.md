# <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer"></a> Class TabControl<T\>.TabFillFlowContainer

Namespace: [osu.Framework.Graphics.UserInterface](osu.Framework.Graphics.UserInterface.md)  
Assembly: osu.Framework.dll  

```csharp
public class TabControl<T>.TabFillFlowContainer : FillFlowContainer<TabItem<T>>, IDependencyInjectionCandidate, IDisposable, IContainerEnumerable<TabItem<T>>, IContainerCollection<TabItem<T>>, IContainer, IDrawable, ICollection<TabItem<T>>, IReadOnlyList<TabItem<T>>, IReadOnlyCollection<TabItem<T>>, IEnumerable<TabItem<T>>, IEnumerable, IFillFlowContainer, ITransformable, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedHandleInputCache
```
...
[Container<TabItem<T\>\>](osu.Framework.Graphics.Containers.Container\-1.md) ← 
[FlowContainer<TabItem<T\>\>](osu.Framework.Graphics.Containers.FlowContainer\-1.md) ← 
[FillFlowContainer<TabItem<T\>\>](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md) ← 
[TabControl<T\>.TabFillFlowContainer](osu.Framework.Graphics.UserInterface.TabControl\-1.TabFillFlowContainer.md)

#### Implements

[IDependencyInjectionCandidate](osu.Framework.Allocation.IDependencyInjectionCandidate.md), 
[IDisposable](https://learn.microsoft.com/dotnet/api/system.idisposable), 
[IContainerEnumerable<TabItem<T\>\>](osu.Framework.Graphics.Containers.IContainerEnumerable\-1.md), 
[IContainerCollection<TabItem<T\>\>](osu.Framework.Graphics.Containers.IContainerCollection\-1.md), 
[IContainer](osu.Framework.Graphics.Containers.IContainer.md), 
[IDrawable](osu.Framework.Graphics.IDrawable.md), 
[ICollection<TabItem<T\>\>](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection\-1), 
[IReadOnlyList<TabItem<T\>\>](https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlylist\-1), 
[IReadOnlyCollection<TabItem<T\>\>](https://learn.microsoft.com/dotnet/api/system.collections.generic.ireadonlycollection\-1), 
[IEnumerable<TabItem<T\>\>](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1), 
...
[FillFlowContainer<TabItem<T\>\>.Direction](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FillFlowContainer\_1\_Direction), 
[FillFlowContainer<TabItem<T\>\>.Spacing](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FillFlowContainer\_1\_Spacing), 
[FillFlowContainer<TabItem<T\>\>.ComputeLayoutPositions\(\)](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FillFlowContainer\_1\_ComputeLayoutPositions), 
[FillFlowContainer<TabItem<T\>\>.ForceNewRow\(Drawable\)](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FillFlowContainer\_1\_ForceNewRow\_osu\_Framework\_Graphics\_Drawable\_), 
[FillFlowContainer<TabItem<T\>\>.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.FillFlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FillFlowContainer\_1\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[FlowContainer<TabItem<T\>\>.LayoutEasing](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_LayoutEasing), 
[FlowContainer<TabItem<T\>\>.LayoutDuration](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_LayoutDuration), 
[FlowContainer<TabItem<T\>\>.MaximumSize](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_MaximumSize), 
[FlowContainer<TabItem<T\>\>.RequiresChildrenUpdate](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_RequiresChildrenUpdate), 
[FlowContainer<TabItem<T\>\>.InvalidateLayout\(\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_InvalidateLayout), 
[FlowContainer<TabItem<T\>\>.AddInternal\(Drawable\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_AddInternal\_osu\_Framework\_Graphics\_Drawable\_), 
[FlowContainer<TabItem<T\>\>.RemoveInternal\(Drawable, bool\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_RemoveInternal\_osu\_Framework\_Graphics\_Drawable\_System\_Boolean\_), 
[FlowContainer<TabItem<T\>\>.ClearInternal\(bool\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_ClearInternal\_System\_Boolean\_), 
[FlowContainer<TabItem<T\>\>.SetLayoutPosition\(Drawable, float\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_SetLayoutPosition\_osu\_Framework\_Graphics\_Drawable\_System\_Single\_), 
[FlowContainer<TabItem<T\>\>.Insert\(int, TabItem<T\>\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_Insert\_System\_Int32\_\_0\_), 
[FlowContainer<TabItem<T\>\>.GetLayoutPosition\(Drawable\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_GetLayoutPosition\_osu\_Framework\_Graphics\_Drawable\_), 
[FlowContainer<TabItem<T\>\>.UpdateChildrenLife\(\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_UpdateChildrenLife), 
[FlowContainer<TabItem<T\>\>.FlowingChildren](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_FlowingChildren), 
[FlowContainer<TabItem<T\>\>.ComputeLayoutPositions\(\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_ComputeLayoutPositions), 
[FlowContainer<TabItem<T\>\>.UpdateAfterChildren\(\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_UpdateAfterChildren), 
[FlowContainer<TabItem<T\>\>.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.FlowContainer\-1.md\#osu\_Framework\_Graphics\_Containers\_FlowContainer\_1\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[Container<TabItem<T\>\>.Content](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Content), 
[Container<TabItem<T\>\>.Children](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Children), 
[Container<TabItem<T\>\>.AliveChildren](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AliveChildren), 
[Container<TabItem<T\>\>.this\[int\]](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Item\_System\_Int32\_), 
[Container<TabItem<T\>\>.Count](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Count), 
[Container<TabItem<T\>\>.IsReadOnly](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_IsReadOnly), 
[Container<TabItem<T\>\>.CopyTo\(TabItem<T\>\[\], int\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_CopyTo\_\_0\_\_\_System\_Int32\_), 
[Container<TabItem<T\>\>.GetEnumerator\(\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_GetEnumerator), 
[Container<TabItem<T\>\>.ChildrenEnumerable](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_ChildrenEnumerable), 
[Container<TabItem<T\>\>.Child](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Child), 
[Container<TabItem<T\>\>.IndexOf\(TabItem<T\>\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_IndexOf\_\_0\_), 
[Container<TabItem<T\>\>.Contains\(TabItem<T\>\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Contains\_\_0\_), 
[Container<TabItem<T\>\>.Add\(TabItem<T\>\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Add\_\_0\_), 
[Container<TabItem<T\>\>.AddRange\(IEnumerable<TabItem<T\>\>\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AddRange\_System\_Collections\_Generic\_IEnumerable\_\_0\_\_), 
[Container<TabItem<T\>\>.AddInternal\(Drawable\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AddInternal\_osu\_Framework\_Graphics\_Drawable\_), 
[Container<TabItem<T\>\>.Remove\(TabItem<T\>, bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Remove\_\_0\_System\_Boolean\_), 
[Container<TabItem<T\>\>.RemoveAll\(Predicate<TabItem<T\>\>, bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RemoveAll\_System\_Predicate\_\_0\_\_System\_Boolean\_), 
[Container<TabItem<T\>\>.RemoveRange\(IEnumerable<TabItem<T\>\>, bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RemoveRange\_System\_Collections\_Generic\_IEnumerable\_\_0\_\_System\_Boolean\_), 
[Container<TabItem<T\>\>.RemoveInternal\(Drawable, bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RemoveInternal\_osu\_Framework\_Graphics\_Drawable\_System\_Boolean\_), 
[Container<TabItem<T\>\>.Clear\(\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Clear), 
[Container<TabItem<T\>\>.Clear\(bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Clear\_System\_Boolean\_), 
[Container<TabItem<T\>\>.ClearInternal\(bool\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_ClearInternal\_System\_Boolean\_), 
[Container<TabItem<T\>\>.ChangeChildDepth\(TabItem<T\>, float\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_ChangeChildDepth\_\_0\_System\_Single\_), 
[Container<TabItem<T\>\>.Masking](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Masking), 
[Container<TabItem<T\>\>.MaskingSmoothness](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_MaskingSmoothness), 
[Container<TabItem<T\>\>.CornerRadius](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_CornerRadius), 
[Container<TabItem<T\>\>.CornerExponent](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_CornerExponent), 
[Container<TabItem<T\>\>.BorderThickness](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_BorderThickness), 
[Container<TabItem<T\>\>.BorderColour](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_BorderColour), 
[Container<TabItem<T\>\>.EdgeEffect](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_EdgeEffect), 
[Container<TabItem<T\>\>.Padding](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_Padding), 
[Container<TabItem<T\>\>.ForceLocalVertexBatch](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_ForceLocalVertexBatch), 
[Container<TabItem<T\>\>.RelativeChildSize](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RelativeChildSize), 
[Container<TabItem<T\>\>.RelativeChildOffset](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RelativeChildOffset), 
[Container<TabItem<T\>\>.AutoSizeAxes](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AutoSizeAxes), 
[Container<TabItem<T\>\>.AutoSizeDuration](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AutoSizeDuration), 
[Container<TabItem<T\>\>.AutoSizeEasing](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_AutoSizeEasing), 
[Container<TabItem<T\>\>.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.Container\-1.md\#osu\_Framework\_Graphics\_Containers\_Container\_1\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, params TransformSequence<TabControl<T\>.TabFillFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, params TransformSequence<TabControl<T\>.TabFillFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Color4, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Color4, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[EnumerableExtensions.ForEach<TabItem<T\>\>\(IEnumerable<TabItem<T\>\>, Action<TabItem<T\>\>\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_ForEach\_\_1\_System\_Collections\_Generic\_IEnumerable\_\_\_0\_\_System\_Action\_\_\_0\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
[EnumerableExtensions.GetNext<TabItem<T\>\>\(IEnumerable<TabItem<T\>\>, TabItem<T\>\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_GetNext\_\_1\_System\_Collections\_Generic\_IEnumerable\_\_\_0\_\_\_\_0\_), 
[EnumerableExtensions.GetPrevious<TabItem<T\>\>\(IEnumerable<TabItem<T\>\>, TabItem<T\>\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_GetPrevious\_\_1\_System\_Collections\_Generic\_IEnumerable\_\_\_0\_\_\_\_0\_), 
[EnumExtensions.GetValuesInOrder<TabItem<T\>\>\(IEnumerable<TabItem<T\>\>\)](osu.Framework.Extensions.EnumExtensions.EnumExtensions.md\#osu\_Framework\_Extensions\_EnumExtensions\_EnumExtensions\_GetValuesInOrder\_\_1\_System\_Collections\_Generic\_IEnumerable\_\_\_0\_\_), 
...
[ObjectExtensions.IsNotNull<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, int, params TransformSequence<TabControl<T\>.TabFillFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, params TransformSequence<TabControl<T\>.TabFillFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, params TransformSequence<TabControl<T\>.TabFillFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<TabControl<T\>.TabFillFlowContainer, TValue\>\(TabControl<T\>.TabFillFlowContainer, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<TabControl<T\>.TabFillFlowContainer, TEasing, TValue\>\(TabControl<T\>.TabFillFlowContainer, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Transform<TValue, DefaultEasingFunction, TabControl<T\>.TabFillFlowContainer\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Transform<TValue, TEasing, TabControl<T\>.TabFillFlowContainer\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
...
[TransformableExtensions.TransformBindableTo<TabControl<T\>.TabFillFlowContainer, TValue\>\(TabControl<T\>.TabFillFlowContainer, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<TabControl<T\>.TabFillFlowContainer, TValue, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformSpacingTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformSpacingTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformSpacingTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformSpacingTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformTo<TabControl<T\>.TabFillFlowContainer, TValue\>\(TabControl<T\>.TabFillFlowContainer, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<TabControl<T\>.TabFillFlowContainer, TValue, TEasing\>\(TabControl<T\>.TabFillFlowContainer, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[TransformableExtensions.TweenEdgeEffectTo<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, EdgeEffectParameters, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TweenEdgeEffectTo<TabControl<T\>.TabFillFlowContainer, TEasing\>\(TabControl<T\>.TabFillFlowContainer, EdgeEffectParameters, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_\_\_1\_\_), 
[DrawableExtensions.With<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer, Action<TabControl<T\>.TabFillFlowContainer\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<TabControl<T\>.TabFillFlowContainer, TChild\>\(TabControl<T\>.TabFillFlowContainer, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<TabControl<T\>.TabFillFlowContainer, TChild\>\(TabControl<T\>.TabFillFlowContainer, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<TabControl<T\>.TabFillFlowContainer, TChild\>\(TabControl<T\>.TabFillFlowContainer, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<TabControl<T\>.TabFillFlowContainer\>\(TabControl<T\>.TabFillFlowContainer\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Fields

### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_TabVisibilityChanged"></a> TabVisibilityChanged

Gets called whenever the visibility of a tab in this container changes. Gets invoked with the <xref href="osu.Framework.Graphics.UserInterface.TabItem" data-throw-if-not-resolved="false"></xref> whose visibility changed and the new visibility state (true = visible, false = hidden).
...
#### Field Value
 ...
 [Action](https://learn.microsoft.com/dotnet/api/system.action\-2)<[TabItem](osu.Framework.Graphics.UserInterface.TabItem\-1.md)<T\>, [bool](https://learn.microsoft.com/dotnet/api/system.boolean)\>

## Properties

### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_AllTabItems"></a> AllTabItems

The list of all tabs in this container, in order of appearance.

```csharp
public IEnumerable<TabItem<T>> AllTabItems { get; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_AllowMultiline"></a> AllowMultiline
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_FlowingChildren"></a> FlowingChildren
...
```csharp
public override sealed IEnumerable<Drawable> FlowingChildren { get; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_TabItems"></a> TabItems

The list of tabs currently displayed by this container, in order of appearance.

```csharp
public IEnumerable<TabItem<T>> TabItems { get; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_Clear_System_Boolean_"></a> Clear\(bool\)
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_ComputeLayoutPositions"></a> ComputeLayoutPositions\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_GetFlowingTabs_System_Collections_Generic_IEnumerable_osu_Framework_Graphics_Drawable__"></a> GetFlowingTabs\(IEnumerable<Drawable\>\)

Re-orders a given list of <xref href="osu.Framework.Graphics.UserInterface.TabItem%601" data-throw-if-not-resolved="false"></xref>s in the order that they should appear.
...
`tabs` [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1)<[Drawable](osu.Framework.Graphics.Drawable.md)\>

The <xref href="osu.Framework.Graphics.UserInterface.TabItem%601" data-throw-if-not-resolved="false"></xref>s to order.

#### Returns

 [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1)<[Drawable](osu.Framework.Graphics.Drawable.md)\>

The re-ordered list of <xref href="osu.Framework.Graphics.UserInterface.TabItem%601" data-throw-if-not-resolved="false"></xref>s.

### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
...
### <a id="osu_Framework_Graphics_UserInterface_TabControl_1_TabFillFlowContainer_Remove_osu_Framework_Graphics_UserInterface_TabItem__0__System_Boolean_"></a> Remove\(TabItem<T\>, bool\)
...
`drawable` [TabItem](osu.Framework.Graphics.UserInterface.TabItem\-1.md)<T\>
