# <a id="osu_Framework_Graphics_UserInterface_Popover"></a> Class Popover

Namespace: [osu.Framework.Graphics.UserInterface](osu.Framework.Graphics.UserInterface.md)  
Assembly: osu.Framework.dll  

A <xref href="osu.Framework.Graphics.UserInterface.Popover" data-throw-if-not-resolved="false"></xref> is a transient view that appears above other on-screen content.
...
```csharp
public abstract class Popover : OverlayContainer, IDependencyInjectionCandidate, IDisposable, IContainerEnumerable<Drawable>, IContainerCollection<Drawable>, IContainer, IDrawable, ITransformable, ICollection<Drawable>, IReadOnlyList<Drawable>, IReadOnlyCollection<Drawable>, IEnumerable<Drawable>, IEnumerable, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedHandleInputCache
```
...
[Popover](osu.Framework.Graphics.UserInterface.Popover.md)

#### Derived

[BasicPopover](osu.Framework.Graphics.UserInterface.BasicPopover.md)
...
[OverlayContainer.BlockPositionalInput](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_BlockPositionalInput), 
[OverlayContainer.BlockScrollInput](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_BlockScrollInput), 
[OverlayContainer.BlockNonPositionalInput](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_BlockNonPositionalInput), 
[OverlayContainer.DragBlocksClick](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_DragBlocksClick), 
[OverlayContainer.OnHover\(HoverEvent\)](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_OnHover\_osu\_Framework\_Input\_Events\_HoverEvent\_), 
[OverlayContainer.OnMouseDown\(MouseDownEvent\)](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_OnMouseDown\_osu\_Framework\_Input\_Events\_MouseDownEvent\_), 
[OverlayContainer.OnMouseMove\(MouseMoveEvent\)](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_OnMouseMove\_osu\_Framework\_Input\_Events\_MouseMoveEvent\_), 
[OverlayContainer.OnScroll\(ScrollEvent\)](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_OnScroll\_osu\_Framework\_Input\_Events\_ScrollEvent\_), 
[OverlayContainer.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.OverlayContainer.md\#osu\_Framework\_Graphics\_Containers\_OverlayContainer\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[VisibilityContainer.State](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_State), 
[VisibilityContainer.StartHidden](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_StartHidden), 
[VisibilityContainer.LoadAsyncComplete\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_LoadAsyncComplete), 
[VisibilityContainer.LoadComplete\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_LoadComplete), 
[VisibilityContainer.Show\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_Show), 
[VisibilityContainer.Hide\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_Hide), 
[VisibilityContainer.ToggleVisibility\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_ToggleVisibility), 
[VisibilityContainer.PropagateNonPositionalInputSubTree](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_PropagateNonPositionalInputSubTree), 
[VisibilityContainer.PropagatePositionalInputSubTree](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_PropagatePositionalInputSubTree), 
[VisibilityContainer.PopIn\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_PopIn), 
[VisibilityContainer.PopOut\(\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_PopOut), 
[VisibilityContainer.UpdateState\(ValueChangedEvent<Visibility\>\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_UpdateState\_osu\_Framework\_Bindables\_ValueChangedEvent\_osu\_Framework\_Graphics\_Containers\_Visibility\_\_), 
[VisibilityContainer.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.VisibilityContainer.md\#osu\_Framework\_Graphics\_Containers\_VisibilityContainer\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<Popover\>\(Popover, params TransformSequence<Popover\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<Popover\>\(Popover?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<Popover\>\(Popover, double, params TransformSequence<Popover\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<Popover\>\(Popover\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<Popover\>\(Popover, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<Popover, TEasing\>\(Popover, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<Popover\>\(Popover, Color4, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<Popover, TEasing\>\(Popover, Color4, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<Popover\>\(Popover, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<Popover, TEasing\>\(Popover, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<Popover\>\(Popover, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<Popover, TEasing\>\(Popover, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<Popover\>\(Popover, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<Popover, TEasing\>\(Popover, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<Popover\>\(Popover, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<Popover, TEasing\>\(Popover, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<Popover\>\(Popover, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<Popover, TEasing\>\(Popover, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
...
[ExtensionMethods.GetLocalisableDescription<Popover\>\(Popover\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<Popover\>\(Popover\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<Popover\>\(Popover\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<Popover\>\(Popover, double, int, params TransformSequence<Popover\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<Popover\>\(Popover, double, params TransformSequence<Popover\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<Popover\>\(Popover, params TransformSequence<Popover\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<Popover\>\(Popover, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<Popover, TValue\>\(Popover, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<Popover, TEasing, TValue\>\(Popover, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<Popover\>\(Popover, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<Popover, TEasing\>\(Popover, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, Popover\>\(Popover, Transform<TValue, DefaultEasingFunction, Popover\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, Popover\>\(Popover, Transform<TValue, TEasing, Popover\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<Popover\>\(Popover, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<Popover, TEasing\>\(Popover, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<Popover\>\(Popover, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
[TransformableExtensions.Spin<Popover\>\(Popover, double, RotationDirection, float, int\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_System\_Int32\_), 
[TransformableExtensions.TransformBindableTo<Popover, TValue\>\(Popover, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<Popover, TValue, TEasing\>\(Popover, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<Popover\>\(Popover, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<Popover, TEasing\>\(Popover, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformTo<Popover, TValue\>\(Popover, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<Popover, TValue, TEasing\>\(Popover, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<Popover\>\(Popover, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[TransformableExtensions.TweenEdgeEffectTo<Popover\>\(Popover, EdgeEffectParameters, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TweenEdgeEffectTo<Popover, TEasing\>\(Popover, EdgeEffectParameters, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_\_\_1\_\_), 
[DrawableExtensions.With<Popover\>\(Popover, Action<Popover\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<Popover, TChild\>\(Popover, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<Popover, TChild\>\(Popover, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<Popover, TChild\>\(Popover, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<Popover\>\(Popover\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_UserInterface_Popover__ctor"></a> Popover\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_AcceptsFocus"></a> AcceptsFocus
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_AllowableAnchors"></a> AllowableAnchors

The collection of <xref href="osu.Framework.Graphics.Anchor" data-throw-if-not-resolved="false"></xref>s to consider when auto-layouting the popover inside a <xref href="osu.Framework.Graphics.Cursor.PopoverContainer" data-throw-if-not-resolved="false"></xref>.
...
#### Property Value
 ...
 [IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable\-1)<[Anchor](osu.Framework.Graphics.Anchor.md)\>

#### Remarks

<xref href="osu.Framework.Graphics.Anchor.Centre" data-throw-if-not-resolved="false"></xref> is used as a fallback if an empty enumerable is provided, or any other anchor fails.

### <a id="osu_Framework_Graphics_UserInterface_Popover_Arrow"></a> Arrow

The arrow of this <xref href="osu.Framework.Graphics.UserInterface.Popover" data-throw-if-not-resolved="false"></xref>, pointing at the component which triggered it.
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Background"></a> Background
...
#### Property Value
 ...
 [Box](osu.Framework.Graphics.Shapes.Box.md)

### <a id="osu_Framework_Graphics_UserInterface_Popover_BlockPositionalInput"></a> BlockPositionalInput
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Body"></a> Body

The body of this <xref href="osu.Framework.Graphics.UserInterface.Popover" data-throw-if-not-resolved="false"></xref>, containing the actual contents.

```csharp
protected Container Body { get; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Content"></a> Content
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_HandleNonPositionalInput"></a> HandleNonPositionalInput
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Height"></a> Height
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_PopoverAnchor"></a> PopoverAnchor

The <xref href="osu.Framework.Graphics.Anchor" data-throw-if-not-resolved="false"></xref> that this <xref href="osu.Framework.Graphics.UserInterface.Popover" data-throw-if-not-resolved="false"></xref> is to be attached to the triggering UI control by.

```csharp
public Anchor PopoverAnchor { get; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_RequestsFocus"></a> RequestsFocus
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Size"></a> Size
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_Width"></a> Width
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_AddInternal_osu_Framework_Graphics_Drawable_"></a> AddInternal\(Drawable\)
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_AnchorUpdated_osu_Framework_Graphics_Anchor_"></a> AnchorUpdated\(Anchor\)

Called when <xref href="osu.Framework.Graphics.Anchor" data-throw-if-not-resolved="false"></xref> is set.
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_ComputeIsMaskedAway_osu_Framework_Graphics_Primitives_RectangleF_"></a> ComputeIsMaskedAway\(RectangleF\)
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_CreateArrow"></a> CreateArrow\(\)

Creates an arrow drawable that points away from the given <xref href="osu.Framework.Graphics.Anchor" data-throw-if-not-resolved="false"></xref>.
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_OnKeyDown_osu_Framework_Input_Events_KeyDownEvent_"></a> OnKeyDown\(KeyDownEvent\)
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_PopIn"></a> PopIn\(\)

Implement any transition to be played when <xref href="osu.Framework.Graphics.Containers.VisibilityContainer.State" data-throw-if-not-resolved="false"></xref> becomes <xref href="osu.Framework.Graphics.Containers.Visibility.Visible" data-throw-if-not-resolved="false"></xref>.

```csharp
protected override void PopIn()
```

### <a id="osu_Framework_Graphics_UserInterface_Popover_PopOut"></a> PopOut\(\)

Implement any transition to be played when <xref href="osu.Framework.Graphics.Containers.VisibilityContainer.State" data-throw-if-not-resolved="false"></xref> becomes <xref href="osu.Framework.Graphics.Containers.Visibility.Hidden" data-throw-if-not-resolved="false"></xref>.
Will be invoked once on <xref href="osu.Framework.Graphics.Containers.VisibilityContainer.LoadComplete" data-throw-if-not-resolved="false"></xref> if <xref href="osu.Framework.Graphics.Containers.VisibilityContainer.StartHidden" data-throw-if-not-resolved="false"></xref> is set.

```csharp
protected override void PopOut()
```

### <a id="osu_Framework_Graphics_UserInterface_Popover_ReceivePositionalInputAt_osuTK_Vector2_"></a> ReceivePositionalInputAt\(Vector2\)
...
### <a id="osu_Framework_Graphics_UserInterface_Popover_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
