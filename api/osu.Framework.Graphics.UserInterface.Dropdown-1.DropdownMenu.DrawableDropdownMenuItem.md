# <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem"></a> Class Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem

Namespace: [osu.Framework.Graphics.UserInterface](osu.Framework.Graphics.UserInterface.md)  
Assembly: osu.Framework.dll  

```csharp
public abstract class Dropdown<T>.DropdownMenu.DrawableDropdownMenuItem : Menu.DrawableMenuItem, IDependencyInjectionCandidate, IDisposable, IDrawable, ITransformable, IStateful<MenuItemState>, IFilterable, IHasFilterTerms, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedDependencyActivator, ISourceGeneratedHandleInputCache
```
...
[Menu.DrawableMenuItem.StateChanged](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_StateChanged), 
[Menu.DrawableMenuItem.Item](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_Item), 
[Menu.DrawableMenuItem.Content](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_Content), 
[Menu.DrawableMenuItem.Background](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_Background), 
[Menu.DrawableMenuItem.Foreground](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_Foreground), 
[Menu.DrawableMenuItem.CloseMenuOnClick](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_CloseMenuOnClick), 
[Menu.DrawableMenuItem.FilterTerms](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_FilterTerms), 
[Menu.DrawableMenuItem.SetFlowDirection\(Direction\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_SetFlowDirection\_osu\_Framework\_Graphics\_Direction\_), 
[Menu.DrawableMenuItem.BackgroundColour](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_BackgroundColour), 
[Menu.DrawableMenuItem.ForegroundColour](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_ForegroundColour), 
[Menu.DrawableMenuItem.BackgroundColourHover](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_BackgroundColourHover), 
[Menu.DrawableMenuItem.ForegroundColourHover](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_ForegroundColourHover), 
[Menu.DrawableMenuItem.State](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_State), 
[Menu.DrawableMenuItem.ContentDrawWidth](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_ContentDrawWidth), 
[Menu.DrawableMenuItem.ContentDrawHeight](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_ContentDrawHeight), 
[Menu.DrawableMenuItem.IsActionable](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_IsActionable), 
[Menu.DrawableMenuItem.UpdateBackgroundColour\(\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_UpdateBackgroundColour), 
[Menu.DrawableMenuItem.UpdateForegroundColour\(\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_UpdateForegroundColour), 
[Menu.DrawableMenuItem.LoadComplete\(\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_LoadComplete), 
[Menu.DrawableMenuItem.OnHover\(HoverEvent\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_OnHover\_osu\_Framework\_Input\_Events\_HoverEvent\_), 
[Menu.DrawableMenuItem.OnHoverLost\(HoverLostEvent\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_OnHoverLost\_osu\_Framework\_Input\_Events\_HoverLostEvent\_), 
[Menu.DrawableMenuItem.OnClick\(ClickEvent\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_OnClick\_osu\_Framework\_Input\_Events\_ClickEvent\_), 
[Menu.DrawableMenuItem.CreateBackground\(\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_CreateBackground), 
[Menu.DrawableMenuItem.CreateContent\(\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_CreateContent), 
[Menu.DrawableMenuItem.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.UserInterface.Menu.DrawableMenuItem.md\#osu\_Framework\_Graphics\_UserInterface\_Menu\_DrawableMenuItem\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, params TransformSequence<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, double, params TransformSequence<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
...
[TransformableExtensions.FlashColour<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TValue\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing, TValue\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.PopulateTransform<TValue, Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Transform<TValue, DefaultEasingFunction, Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Transform<TValue, TEasing, Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.TransformBindableTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TValue\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TValue, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TValue\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TValue, TEasing\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[DrawableExtensions.With<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, Action<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TChild\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TChild\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TChild\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\>\(Dropdown<T\>.DropdownMenu.DrawableDropdownMenuItem\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem__ctor_osu_Framework_Graphics_UserInterface_MenuItem_"></a> DrawableDropdownMenuItem\(MenuItem\)
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_BackgroundColourSelected"></a> BackgroundColourSelected

```csharp
public Color4 BackgroundColourSelected { get; set; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_FilteringActive"></a> FilteringActive

Whether a filter is currently being performed.

```csharp
public virtual bool FilteringActive { set; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_ForegroundColourSelected"></a> ForegroundColourSelected

```csharp
public Color4 ForegroundColourSelected { get; set; }
```
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_IsPreSelected"></a> IsPreSelected

Denotes whether this menu item will be selected on <xref href="osuTK.Input.Key.Enter" data-throw-if-not-resolved="false"></xref> press.
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_IsSelected"></a> IsSelected
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_MatchingFilter"></a> MatchingFilter
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_OnHover_osu_Framework_Input_Events_HoverEvent_"></a> OnHover\(HoverEvent\)
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_OnSelectChange"></a> OnSelectChange\(\)

```csharp
protected virtual void OnSelectChange()
```

### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_UpdateBackgroundColour"></a> UpdateBackgroundColour\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_UpdateFilteringState_System_Boolean_"></a> UpdateFilteringState\(bool\)
...
`filtered` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_UpdateForegroundColour"></a> UpdateForegroundColour\(\)
...
### <a id="osu_Framework_Graphics_UserInterface_Dropdown_1_DropdownMenu_DrawableDropdownMenuItem_PreselectionRequested"></a> PreselectionRequested
...
#### Event Type
 ...
 [Action](https://learn.microsoft.com/dotnet/api/system.action\-1)<[DropdownMenuItem](osu.Framework.Graphics.UserInterface.DropdownMenuItem\-1.md)<T\>\>
