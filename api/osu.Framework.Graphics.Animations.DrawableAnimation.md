# <a id="osu_Framework_Graphics_Animations_DrawableAnimation"></a> Class DrawableAnimation
...
```csharp
public class DrawableAnimation : Animation<Drawable>, IDependencyInjectionCandidate, IDisposable, IDrawable, ITransformable, IFramedAnimation, IAnimation, ISourceGeneratedHandleInputCache, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedDependencyActivator
```
...
[AnimationClockComposite](osu.Framework.Graphics.Animations.AnimationClockComposite.md) ← 
[Animation<Drawable\>](osu.Framework.Graphics.Animations.Animation\-1.md) ← 
[DrawableAnimation](osu.Framework.Graphics.Animations.DrawableAnimation.md)
...
[IFramedAnimation](osu.Framework.Graphics.Animations.IFramedAnimation.md), 
...
[Animation<Drawable\>.DefaultFrameLength](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_DefaultFrameLength), 
[Animation<Drawable\>.FrameCount](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_FrameCount), 
[Animation<Drawable\>.CurrentFrameIndex](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_CurrentFrameIndex), 
[Animation<Drawable\>.CurrentFrame](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_CurrentFrame), 
[Animation<Drawable\>.GotoFrame\(int\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_GotoFrame\_System\_Int32\_), 
[Animation<Drawable\>.AddFrame\(Drawable, double?\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_AddFrame\_\_0\_System\_Nullable\_System\_Double\_\_), 
[Animation<Drawable\>.AddFrame\(FrameData<Drawable\>\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_AddFrame\_osu\_Framework\_Graphics\_Animations\_FrameData\_\_0\_\_), 
[Animation<Drawable\>.AddFrames\(IEnumerable<Drawable\>\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_AddFrames\_System\_Collections\_Generic\_IEnumerable\_\_0\_\_), 
[Animation<Drawable\>.AddFrames\(IEnumerable<FrameData<Drawable\>\>\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_AddFrames\_System\_Collections\_Generic\_IEnumerable\_osu\_Framework\_Graphics\_Animations\_FrameData\_\_0\_\_\_), 
[Animation<Drawable\>.ClearFrames\(\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_ClearFrames), 
[Animation<Drawable\>.DisplayFrame\(Drawable\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_DisplayFrame\_\_0\_), 
[Animation<Drawable\>.ClearDisplay\(\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_ClearDisplay), 
[Animation<Drawable\>.OnFrameAdded\(Drawable, double\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_OnFrameAdded\_\_0\_System\_Double\_), 
[Animation<Drawable\>.Update\(\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_Update), 
[Animation<Drawable\>.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Animations.Animation\-1.md\#osu\_Framework\_Graphics\_Animations\_Animation\_1\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[AnimationClockComposite.Clock](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_Clock), 
[AnimationClockComposite.LoadComplete\(\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_LoadComplete), 
[AnimationClockComposite.AddInternal\(Drawable\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_AddInternal\_osu\_Framework\_Graphics\_Drawable\_), 
[AnimationClockComposite.CreateContent\(\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_CreateContent), 
[AnimationClockComposite.Update\(\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_Update), 
[AnimationClockComposite.PlaybackPosition](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_PlaybackPosition), 
[AnimationClockComposite.Duration](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_Duration), 
[AnimationClockComposite.IsPlaying](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_IsPlaying), 
[AnimationClockComposite.Loop](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_Loop), 
[AnimationClockComposite.Seek\(double\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_Seek\_System\_Double\_), 
[AnimationClockComposite.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Animations.AnimationClockComposite.md\#osu\_Framework\_Graphics\_Animations\_AnimationClockComposite\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
[CustomisableSizeCompositeDrawable.Width](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_Width), 
[CustomisableSizeCompositeDrawable.Height](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_Height), 
[CustomisableSizeCompositeDrawable.Size](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_Size), 
[CustomisableSizeCompositeDrawable.GetCurrentDisplaySize\(\)](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_GetCurrentDisplaySize), 
[CustomisableSizeCompositeDrawable.GetFillAspectRatio\(\)](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_GetFillAspectRatio), 
[CustomisableSizeCompositeDrawable.UpdateSizing\(\)](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_UpdateSizing), 
[CustomisableSizeCompositeDrawable.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Animations.CustomisableSizeCompositeDrawable.md\#osu\_Framework\_Graphics\_Animations\_CustomisableSizeCompositeDrawable\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<DrawableAnimation\>\(DrawableAnimation, params TransformSequence<DrawableAnimation\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<DrawableAnimation\>\(DrawableAnimation?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<DrawableAnimation\>\(DrawableAnimation, double, params TransformSequence<DrawableAnimation\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<DrawableAnimation\>\(DrawableAnimation\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<DrawableAnimation\>\(DrawableAnimation, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<DrawableAnimation, TEasing\>\(DrawableAnimation, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<DrawableAnimation\>\(DrawableAnimation, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<DrawableAnimation, TEasing\>\(DrawableAnimation, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<DrawableAnimation\>\(DrawableAnimation, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<DrawableAnimation, TEasing\>\(DrawableAnimation, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<DrawableAnimation\>\(DrawableAnimation, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<DrawableAnimation, TEasing\>\(DrawableAnimation, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<DrawableAnimation\>\(DrawableAnimation, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<DrawableAnimation, TEasing\>\(DrawableAnimation, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<DrawableAnimation\>\(DrawableAnimation, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<DrawableAnimation, TEasing\>\(DrawableAnimation, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<DrawableAnimation\>\(DrawableAnimation\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<DrawableAnimation\>\(DrawableAnimation\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<DrawableAnimation\>\(DrawableAnimation\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<DrawableAnimation\>\(DrawableAnimation, double, int, params TransformSequence<DrawableAnimation\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DrawableAnimation\>\(DrawableAnimation, double, params TransformSequence<DrawableAnimation\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DrawableAnimation\>\(DrawableAnimation, params TransformSequence<DrawableAnimation\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DrawableAnimation\>\(DrawableAnimation, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<DrawableAnimation, TValue\>\(DrawableAnimation, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<DrawableAnimation, TEasing, TValue\>\(DrawableAnimation, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<DrawableAnimation\>\(DrawableAnimation, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<DrawableAnimation\>\(DrawableAnimation, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<DrawableAnimation, TEasing\>\(DrawableAnimation, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<DrawableAnimation, TEasing\>\(DrawableAnimation, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<DrawableAnimation\>\(DrawableAnimation, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<DrawableAnimation, TEasing\>\(DrawableAnimation, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<DrawableAnimation\>\(DrawableAnimation, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<DrawableAnimation, TEasing\>\(DrawableAnimation, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.RotateTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<DrawableAnimation\>\(DrawableAnimation, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<DrawableAnimation\>\(DrawableAnimation, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<DrawableAnimation, TEasing\>\(DrawableAnimation, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<DrawableAnimation, TEasing\>\(DrawableAnimation, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<DrawableAnimation\>\(DrawableAnimation, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
[TransformableExtensions.Spin<DrawableAnimation\>\(DrawableAnimation, double, RotationDirection, float, int\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_System\_Int32\_), 
...
[TransformableExtensions.TransformBindableTo<DrawableAnimation, TValue\>\(DrawableAnimation, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<DrawableAnimation, TValue, TEasing\>\(DrawableAnimation, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformTo<DrawableAnimation, TValue\>\(DrawableAnimation, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<DrawableAnimation, TValue, TEasing\>\(DrawableAnimation, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<DrawableAnimation\>\(DrawableAnimation, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[DrawableExtensions.With<DrawableAnimation\>\(DrawableAnimation, Action<DrawableAnimation\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<DrawableAnimation, TChild\>\(DrawableAnimation, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<DrawableAnimation, TChild\>\(DrawableAnimation, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<DrawableAnimation, TChild\>\(DrawableAnimation, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<DrawableAnimation\>\(DrawableAnimation\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Methods

### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_ClearDisplay"></a> ClearDisplay\(\)
...
Called when resetting the animation, ie. on <xref href="osu.Framework.Graphics.Animations.Animation%601.ClearFrames" data-throw-if-not-resolved="false"></xref>.

### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_CreateContent"></a> CreateContent\(\)
...
The container providing the content to be added into this <xref href="osu.Framework.Graphics.Animations.AnimationClockComposite" data-throw-if-not-resolved="false"></xref>'s hierarchy.

### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_DisplayFrame_osu_Framework_Graphics_Drawable_"></a> DisplayFrame\(Drawable\)
...
`content` [Drawable](osu.Framework.Graphics.Drawable.md)

The content that will be displayed.

#### Remarks

This method will only be called after <xref href="osu.Framework.Graphics.Animations.Animation%601.OnFrameAdded(%600%2cSystem.Double)" data-throw-if-not-resolved="false"></xref> has been called at least once.

### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_GetCurrentDisplaySize"></a> GetCurrentDisplaySize\(\)
...
The size of current content.

### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_GetFillAspectRatio"></a> GetFillAspectRatio\(\)
...
### <a id="osu_Framework_Graphics_Animations_DrawableAnimation_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
