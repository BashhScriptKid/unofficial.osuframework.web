# <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer"></a> Class MarkdownTextFlowContainer
...
```csharp
public class MarkdownTextFlowContainer : CustomizableTextContainer, IDependencyInjectionCandidate, IDisposable, IContainerEnumerable<Drawable>, IContainerCollection<Drawable>, IContainer, IDrawable, ICollection<Drawable>, IReadOnlyList<Drawable>, IReadOnlyCollection<Drawable>, IEnumerable<Drawable>, IEnumerable, IFillFlowContainer, ITransformable, IMarkdownTextComponent, ISourceGeneratedLongRunningLoadCache, ISourceGeneratedDependencyActivator, ISourceGeneratedHandleInputCache
```
...
[IMarkdownTextComponent](osu.Framework.Graphics.Containers.Markdown.IMarkdownTextComponent.md), 
...
[CustomizableTextContainer.Escape\(string\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_Escape\_System\_String\_), 
[CustomizableTextContainer.Unescape\(string\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_Unescape\_System\_String\_), 
[CustomizableTextContainer.Placeholders](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_Placeholders), 
[CustomizableTextContainer.AddPlaceholder\(Drawable\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_AddPlaceholder\_osu\_Framework\_Graphics\_Drawable\_), 
[CustomizableTextContainer.AddIconFactory\(string, Delegate\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_AddIconFactory\_System\_String\_System\_Delegate\_), 
[CustomizableTextContainer.AddIconFactory\(string, Func<Drawable\>\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_AddIconFactory\_System\_String\_System\_Func\_osu\_Framework\_Graphics\_Drawable\_\_), 
[CustomizableTextContainer.AddIconFactory\(string, Func<int, Drawable\>\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_AddIconFactory\_System\_String\_System\_Func\_System\_Int32\_osu\_Framework\_Graphics\_Drawable\_\_), 
[CustomizableTextContainer.AddIconFactory\(string, Func<int, int, Drawable\>\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_AddIconFactory\_System\_String\_System\_Func\_System\_Int32\_System\_Int32\_osu\_Framework\_Graphics\_Drawable\_\_), 
[CustomizableTextContainer.CreateChunkFor<TSpriteText\>\(LocalisableString, bool, Func<TSpriteText\>, Action<TSpriteText\>\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_CreateChunkFor\_\_1\_osu\_Framework\_Localisation\_LocalisableString\_System\_Boolean\_System\_Func\_\_\_0\_\_System\_Action\_\_\_0\_\_), 
[CustomizableTextContainer.RecreateAllParts\(\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_RecreateAllParts), 
[CustomizableTextContainer.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.CustomizableTextContainer.md\#osu\_Framework\_Graphics\_Containers\_CustomizableTextContainer\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, params TransformSequence<MarkdownTextFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, params TransformSequence<MarkdownTextFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Color4, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_1\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeEdgeEffectTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeEdgeEffectTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Color4, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeEdgeEffectTo\_\_2\_\_\_0\_osuTK\_Graphics\_Color4\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[ExtensionMethods.GetLocalisableDescription<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, int, params TransformSequence<MarkdownTextFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, params TransformSequence<MarkdownTextFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, params TransformSequence<MarkdownTextFlowContainer\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<MarkdownTextFlowContainer, TValue\>\(MarkdownTextFlowContainer, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<MarkdownTextFlowContainer, TEasing, TValue\>\(MarkdownTextFlowContainer, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Transform<TValue, DefaultEasingFunction, MarkdownTextFlowContainer\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Transform<TValue, TEasing, MarkdownTextFlowContainer\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
...
[TransformableExtensions.TransformBindableTo<MarkdownTextFlowContainer, TValue\>\(MarkdownTextFlowContainer, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<MarkdownTextFlowContainer, TValue, TEasing\>\(MarkdownTextFlowContainer, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildOffsetTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildOffsetTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformRelativeChildSizeTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformRelativeChildSizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformSpacingTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformSpacingTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformSpacingTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformSpacingTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.TransformTo<MarkdownTextFlowContainer, TValue\>\(MarkdownTextFlowContainer, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<MarkdownTextFlowContainer, TValue, TEasing\>\(MarkdownTextFlowContainer, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[TransformableExtensions.TweenEdgeEffectTo<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, EdgeEffectParameters, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TweenEdgeEffectTo<MarkdownTextFlowContainer, TEasing\>\(MarkdownTextFlowContainer, EdgeEffectParameters, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TweenEdgeEffectTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Effects\_EdgeEffectParameters\_System\_Double\_\_\_1\_\_), 
[DrawableExtensions.With<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer, Action<MarkdownTextFlowContainer\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<MarkdownTextFlowContainer, TChild\>\(MarkdownTextFlowContainer, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<MarkdownTextFlowContainer, TChild\>\(MarkdownTextFlowContainer, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<MarkdownTextFlowContainer, TChild\>\(MarkdownTextFlowContainer, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<MarkdownTextFlowContainer\>\(MarkdownTextFlowContainer\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer__ctor"></a> MarkdownTextFlowContainer\(\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_TotalTextWidth"></a> TotalTextWidth

```csharp
public float TotalTextWidth { get; }
```
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddAutoLink_Markdig_Syntax_Inlines_AutolinkInline_"></a> AddAutoLink\(AutolinkInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddCodeInLine_Markdig_Syntax_Inlines_CodeInline_"></a> AddCodeInLine\(CodeInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddCustomComponent_Markdig_Extensions_CustomContainers_CustomContainerInline_"></a> AddCustomComponent\(CustomContainerInline\)
...
`customContainerInline` CustomContainerInline

### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddDrawable_osu_Framework_Graphics_Drawable_"></a> AddDrawable\(Drawable\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddFootnoteBacklink_Markdig_Extensions_Footnotes_FootnoteLink_"></a> AddFootnoteBacklink\(FootnoteLink\)
...
`footnoteBacklink` FootnoteLink

### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddFootnoteLink_Markdig_Extensions_Footnotes_FootnoteLink_"></a> AddFootnoteLink\(FootnoteLink\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddHtmlEntityInlineText_System_String_Markdig_Syntax_Inlines_HtmlEntityInline_"></a> AddHtmlEntityInlineText\(string, HtmlEntityInline\)
...
`entityInLine` HtmlEntityInline

### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddHtmlInLineText_System_String_Markdig_Syntax_Inlines_LiteralInline_"></a> AddHtmlInLineText\(string, LiteralInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddImage_Markdig_Syntax_Inlines_LinkInline_"></a> AddImage\(LinkInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddInlineText_Markdig_Syntax_Inlines_ContainerInline_"></a> AddInlineText\(ContainerInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddLinkText_System_String_Markdig_Syntax_Inlines_LinkInline_"></a> AddLinkText\(string, LinkInline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddNotImplementedInlineText_Markdig_Syntax_Inlines_Inline_"></a> AddNotImplementedInlineText\(Inline\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddParagraph_System_String_System_Action_osu_Framework_Graphics_Sprites_SpriteText__"></a> AddParagraph\(string, Action<SpriteText\>\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_AddText_System_String_System_Action_osu_Framework_Graphics_Sprites_SpriteText__"></a> AddText\(string, Action<SpriteText\>\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_ApplyEmphasisedCreationParameters_osu_Framework_Graphics_Sprites_SpriteText_System_Boolean_System_Boolean_"></a> ApplyEmphasisedCreationParameters\(SpriteText, bool, bool\)

Applies emphasised creation parameters to <xref href="osu.Framework.Graphics.Sprites.SpriteText" data-throw-if-not-resolved="false"></xref>.
...
`spriteText` [SpriteText](osu.Framework.Graphics.Sprites.SpriteText.md)

The <xref href="osu.Framework.Graphics.Sprites.SpriteText" data-throw-if-not-resolved="false"></xref> to be emphasised.

`bold` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Whether the text should be emboldened.

`italic` [bool](https://learn.microsoft.com/dotnet/api/system.boolean)

Whether the text should be italicised.

### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_CreateSpriteText"></a> CreateSpriteText\(\)
...
### <a id="osu_Framework_Graphics_Containers_Markdown_MarkdownTextFlowContainer_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
