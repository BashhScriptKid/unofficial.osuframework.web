# <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper"></a> Class DelayedLoadUnloadWrapper

Namespace: [osu.Framework.Graphics.Containers](osu.Framework.Graphics.Containers.md)  
Assembly: osu.Framework.dll  

```csharp
public class DelayedLoadUnloadWrapper : DelayedLoadWrapper, IDependencyInjectionCandidate, IDisposable, IDrawable, ITransformable, ISourceGeneratedHandleInputCache, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache
```
...
[DelayedLoadWrapper.Game](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_Game), 
[DelayedLoadWrapper.Content](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_Content), 
[DelayedLoadWrapper.ShouldLoadContent](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_ShouldLoadContent), 
[DelayedLoadWrapper.Update\(\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_Update), 
[DelayedLoadWrapper.BeginDelayedLoad\(\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_BeginDelayedLoad), 
[DelayedLoadWrapper.EndDelayedLoad\(Drawable\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_EndDelayedLoad\_osu\_Framework\_Graphics\_Drawable\_), 
[DelayedLoadWrapper.Dispose\(bool\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_Dispose\_System\_Boolean\_), 
[DelayedLoadWrapper.CancelTasks\(\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_CancelTasks), 
[DelayedLoadWrapper.DelayedLoadStarted](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_DelayedLoadStarted), 
[DelayedLoadWrapper.DelayedLoadComplete](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_DelayedLoadComplete), 
[DelayedLoadWrapper.DelayedLoadTriggered](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_DelayedLoadTriggered), 
[DelayedLoadWrapper.DelayedLoadCompleted](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_DelayedLoadCompleted), 
[DelayedLoadWrapper.IsIntersecting](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_IsIntersecting), 
[DelayedLoadWrapper.OnInvalidate\(Invalidation, InvalidationSource\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_OnInvalidate\_osu\_Framework\_Graphics\_Invalidation\_osu\_Framework\_Layout\_InvalidationSource\_), 
[DelayedLoadWrapper.UpdateSubTreeMasking\(\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_UpdateSubTreeMasking), 
[DelayedLoadWrapper.RegisterForDependencyActivation\(IDependencyActivatorRegistry\)](osu.Framework.Graphics.Containers.DelayedLoadWrapper.md\#osu\_Framework\_Graphics\_Containers\_DelayedLoadWrapper\_RegisterForDependencyActivation\_osu\_Framework\_Allocation\_IDependencyActivatorRegistry\_), 
...
[TransformableExtensions.Animate<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, params TransformSequence<DelayedLoadUnloadWrapper\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Animate\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[ObjectExtensions.AsNonNull<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper?\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_AsNonNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Delay<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, params TransformSequence<DelayedLoadUnloadWrapper\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Delay\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.DelayUntilTransformsFinished<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_DelayUntilTransformsFinished\_\_1\_\_\_0\_), 
[TransformableExtensions.FadeColour<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeColour<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeIn<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeIn<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeIn\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeInFromZero<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeInFromZero<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeInFromZero\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOut<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOut<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOut\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeOutFromOne<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeOutFromOne<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeOutFromOne\_\_2\_\_\_0\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.FadeTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FadeTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FadeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.FlashColour<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, ColourInfo, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.FlashColour<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, ColourInfo, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_FlashColour\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Colour\_ColourInfo\_System\_Double\_\_\_1\_\_), 
[ExtensionMethods.GetDescription\(object\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetDescription\_System\_Object\_), 
[ExtensionMethods.GetLocalisableDescription<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper\)](osu.Framework.Extensions.ExtensionMethods.md\#osu\_Framework\_Extensions\_ExtensionMethods\_GetLocalisableDescription\_\_1\_\_\_0\_), 
...
[ObjectExtensions.IsNotNull<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNotNull\_\_1\_\_\_0\_), 
[ObjectExtensions.IsNull<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper\)](osu.Framework.Extensions.ObjectExtensions.ObjectExtensions.md\#osu\_Framework\_Extensions\_ObjectExtensions\_ObjectExtensions\_IsNull\_\_1\_\_\_0\_), 
...
[TransformableExtensions.Loop<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, int, params TransformSequence<DelayedLoadUnloadWrapper\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_System\_Int32\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, params TransformSequence<DelayedLoadUnloadWrapper\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, params TransformSequence<DelayedLoadUnloadWrapper\>.Generator\[\]\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_TransformSequence\_\_\_0\_\_Generator\_\_\_), 
[TransformableExtensions.Loop<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Loop\_\_1\_\_\_0\_System\_Double\_), 
[TransformableExtensions.MakeTransform<DelayedLoadUnloadWrapper, TValue\>\(DelayedLoadUnloadWrapper, string, TValue, double, Easing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_System\_String\_), 
[TransformableExtensions.MakeTransform<DelayedLoadUnloadWrapper, TEasing, TValue\>\(DelayedLoadUnloadWrapper, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MakeTransform\_\_3\_\_\_0\_System\_String\_\_\_2\_System\_Double\_\_\_1\_\_System\_String\_), 
[TransformableExtensions.MoveTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Direction, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, Direction, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveTo\_\_2\_\_\_0\_osu\_Framework\_Graphics\_Direction\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToOffset<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToOffset<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToOffset\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToX<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToX<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToX\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.MoveToY<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.MoveToY<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_MoveToY\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.PopulateTransform<TValue, DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Transform<TValue, DefaultEasingFunction, DelayedLoadUnloadWrapper\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_2\_\_\_1\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_DefaultEasingFunction\_\_\_1\_\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.PopulateTransform<TValue, TEasing, DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Transform<TValue, TEasing, DelayedLoadUnloadWrapper\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_PopulateTransform\_\_3\_\_\_2\_osu\_Framework\_Graphics\_Transforms\_Transform\_\_\_0\_\_\_1\_\_\_2\_\_\_\_0\_System\_Double\_\_\_1\_\_), 
...
[TransformableExtensions.ResizeHeightTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeHeightTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeHeightTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ResizeWidthTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ResizeWidthTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ResizeWidthTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.RotateTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.RotateTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_RotateTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, float, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_System\_Single\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Vector2, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_1\_\_\_0\_osuTK\_Vector2\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.ScaleTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, float, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_System\_Single\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.ScaleTo<DelayedLoadUnloadWrapper, TEasing\>\(DelayedLoadUnloadWrapper, Vector2, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_ScaleTo\_\_2\_\_\_0\_osuTK\_Vector2\_System\_Double\_\_\_1\_\_), 
[TransformableExtensions.Spin<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, double, RotationDirection, float\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_Spin\_\_1\_\_\_0\_System\_Double\_osu\_Framework\_Graphics\_RotationDirection\_System\_Single\_), 
...
[TransformableExtensions.TransformBindableTo<DelayedLoadUnloadWrapper, TValue\>\(DelayedLoadUnloadWrapper, Bindable<TValue\>, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_2\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformBindableTo<DelayedLoadUnloadWrapper, TValue, TEasing\>\(DelayedLoadUnloadWrapper, Bindable<TValue\>, TValue, double, in TEasing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformBindableTo\_\_3\_\_\_0\_osu\_Framework\_Bindables\_Bindable\_\_\_1\_\_\_\_1\_System\_Double\_\_\_2\_\_), 
[TransformableExtensions.TransformTo<DelayedLoadUnloadWrapper, TValue\>\(DelayedLoadUnloadWrapper, string, TValue, double, Easing\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_2\_\_\_0\_System\_String\_\_\_1\_System\_Double\_osu\_Framework\_Graphics\_Easing\_), 
[TransformableExtensions.TransformTo<DelayedLoadUnloadWrapper, TValue, TEasing\>\(DelayedLoadUnloadWrapper, string, TValue, double, in TEasing, string\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_3\_\_\_0\_System\_String\_\_\_1\_System\_Double\_\_\_2\_\_System\_String\_), 
[TransformableExtensions.TransformTo<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Transform\)](osu.Framework.Graphics.TransformableExtensions.md\#osu\_Framework\_Graphics\_TransformableExtensions\_TransformTo\_\_1\_\_\_0\_osu\_Framework\_Graphics\_Transforms\_Transform\_), 
[DrawableExtensions.With<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper, Action<DelayedLoadUnloadWrapper\>\)](osu.Framework.Graphics.DrawableExtensions.md\#osu\_Framework\_Graphics\_DrawableExtensions\_With\_\_1\_\_\_0\_System\_Action\_\_\_0\_\_), 
[ContainerExtensions.WithChild<DelayedLoadUnloadWrapper, TChild\>\(DelayedLoadUnloadWrapper, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChild\_\_2\_\_\_0\_\_\_1\_), 
[ContainerExtensions.WithChildren<DelayedLoadUnloadWrapper, TChild\>\(DelayedLoadUnloadWrapper, IEnumerable<TChild\>\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_WithChildren\_\_2\_\_\_0\_System\_Collections\_Generic\_IEnumerable\_\_\_1\_\_), 
[ContainerExtensions.Wrap<DelayedLoadUnloadWrapper, TChild\>\(DelayedLoadUnloadWrapper, TChild\)](osu.Framework.Graphics.Containers.ContainerExtensions.md\#osu\_Framework\_Graphics\_Containers\_ContainerExtensions\_Wrap\_\_2\_\_\_0\_\_\_1\_), 
[EnumerableExtensions.Yield<DelayedLoadUnloadWrapper\>\(DelayedLoadUnloadWrapper\)](osu.Framework.Extensions.IEnumerableExtensions.EnumerableExtensions.md\#osu\_Framework\_Extensions\_IEnumerableExtensions\_EnumerableExtensions\_Yield\_\_1\_\_\_0\_)

## Constructors

### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper__ctor_System_Func_osu_Framework_Graphics_Drawable__System_Double_System_Double_"></a> DelayedLoadUnloadWrapper\(Func<Drawable\>, double, double\)
...
`createContentFunction` [Func](https://learn.microsoft.com/dotnet/api/system.func\-1)<[Drawable](osu.Framework.Graphics.Drawable.md)\>

`timeBeforeLoad` [double](https://learn.microsoft.com/dotnet/api/system.double)

`timeBeforeUnload` [double](https://learn.microsoft.com/dotnet/api/system.double)

## Properties

### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper_ShouldUnloadContent"></a> ShouldUnloadContent

```csharp
protected bool ShouldUnloadContent { get; }
```
...
### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper_CancelTasks"></a> CancelTasks\(\)

```csharp
protected override void CancelTasks()
```

### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper_Dispose_System_Boolean_"></a> Dispose\(bool\)
...
### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper_EndDelayedLoad_osu_Framework_Graphics_Drawable_"></a> EndDelayedLoad\(Drawable\)
...
### <a id="osu_Framework_Graphics_Containers_DelayedLoadUnloadWrapper_RegisterForDependencyActivation_osu_Framework_Allocation_IDependencyActivatorRegistry_"></a> RegisterForDependencyActivation\(IDependencyActivatorRegistry\)
