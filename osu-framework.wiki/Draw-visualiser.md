...
<div style="background-color: #b0b0b0b0; display: inline-block;">
    <img src="../osu-framework.wiki/img/visualizerGuide.png">
</div>

## Traversing the scene graph

<div style="background-color: #b0b0b0b0; display: inline-block;">
    <img src="../osu-framework.wiki/img/visualiserTraversingGuide.png">
</div>
...
![](/osu-framework.wiki/img/visualiserViewProperties.png)
